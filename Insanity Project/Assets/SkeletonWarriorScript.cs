...
public class SkeletonWarriorScript : MonoBehaviour
{
    ...
    public int maxHealth = 1200; // Maximum health of the enemy
    ...
    public float attackCooldown = 1.2f; // Cooldown between attacks
